...
class EntidadComercialController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return response()->json(["message" => "Entidad Comercial registrada", 200]);
        } catch (\Exception $e) {
            //throw $th;
            DB::rollBack();

            return response()->json(["message" => "Error al registrar Entidad Comercial", 400, "error" => $e->getMessage()]);
        }
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json(["message" => "Entidad Comercial inactiva", 400]);
    }
}
